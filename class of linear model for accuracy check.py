...
class Mylinear_model:
   ...
   def predict_value(self):
    ...
    train_x=np.asanyarray(dff[[self.x]]) #for multiple LinearRegression add more date frame in dff then also add here ex dff[[self.x,self,y,self.z,.....]]
    ...
    test_x=np.asanyarray(dff[[self.x]].head(5)) #for multiple LinearRegression add more date frame in dff then also add here ex dff[[self.x,self,y,self.z,.....]]
